...
namespace Top4ever.Print
{
    public class DriverKitchenPrint
    {
        ...
        public DriverKitchenPrint(string printerName, string paperType)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static DriverKitchenPrint GetInstance(string printerName, string paperType)
        {
            ...
            lock (Obj)
            {
                ...
                {
                    instance = new DriverKitchenPrint(printerName, paperType);
