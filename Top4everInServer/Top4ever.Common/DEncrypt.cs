...
namespace Top4ever.Common
{
    ...
    {
        private const string pKey = "TOP4EVER";

        #region 使用 缺省密钥字符串 加密/解密
        /// <summary>
        /// 使用缺省密钥字符串加密
        /// </summary>
        ...
        {
            return Decrypt(original, pKey, Encoding.Default);
        }
        #endregion

        #region 使用 给定密钥字符串 加密/解密
        /// <summary>
        /// 使用给定密钥字符串加密string
        /// </summary>
